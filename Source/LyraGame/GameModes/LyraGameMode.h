...
DECLARE_DYNAMIC_MULTICAST_DELEGATE(FOnObjectiveReady_DelegateHandle);
...
public:
	// FIRING RANGE ------------------------------------------------------
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "RLEngine")
	AFiringRangeDummy* TargetActor;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "RLEngine")
	FVector TargetLocation;

	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "RLEngine")
	TArray<AActor*> ObjectiveList;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "RLEngine")
	FRLEngineStruct RLEngineStruct;
	
	FOnObjectiveReady_DelegateHandle OnObjectiveReady;
	...
	UFUNCTION(BlueprintCallable, Category = "RLEngine")
	void NextObjective();
