...
class CenteringWorldExtEnv(gym.Env):
    ...
    def __init__(self, size_x=1000, size_y=1000, max_timesteps=50000, distance_percentage=0.03, render_mode=None):
        ...
        self._action_to_direction = {
            ...
            Actions.RIGHT_UP: np.array([self._distance_x, self._distance_y], dtype=np.float32),
            Actions.RIGHT_DOWN: np.array([self._distance_x, -self._distance_y], dtype=np.float32),
            Actions.LEFT_UP: np.array([-self._distance_x, self._distance_y], dtype=np.float32),
            Actions.LEFT_DOWN: np.array([-self._distance_x, -self._distance_y], dtype=np.float32),
        }
